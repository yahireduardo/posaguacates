...
- [ ] Respaldo verificado y guardado fuera del equipo.
- [ ] Migraciones registradas y conteos conciliados.
- [ ] `npm ci`, `npm test` y validación sintáctica aprobados.
- [ ] `/health`, login y recorrido manual completo aprobados.
- [ ] Venta, compra, inventario, cartera y cancelaciones conciliados.
- [ ] ZIP, análisis, restauración y rollback probados en `_test`.
