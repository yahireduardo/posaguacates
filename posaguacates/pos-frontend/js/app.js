...
function configurarCamposCantidadProducto(){const caja=esCaja(productoUnidad.value);productoMinimo.step=caja?'0.5':'0.01';productoMinimo.min='0';productoKilosCaja.step='0.01';productoKilosCaja.min='0.01';productoKilosCaja.required=caja;productoKilosCaja.disabled=!caja;if(!caja)productoKilosCaja.value=''}
