...
AppVersion=1.0.1
DefaultDirName={autopf}\POS Aguacates iPhone Preview
PrivilegesRequired=admin
ArchitecturesAllowed=x64compatible
OutputDir=..\dist
OutputBaseFilename=POS-Aguacates-iPhone-Preview-Setup-1.0.1
Compression=lzma2
SolidCompression=yes
[Files]
Source: "..\dist\POS-Aguacates-iPhone-Preview-1.0.1\*"; DestDir: "{app}"; Flags: recursesubdirs createallsubdirs ignoreversion
[Run]
