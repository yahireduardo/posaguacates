...
test('recorrido transaccional HTTP completo',async()=>{
  ...
  const ventaKey='venta-integracion-0001',venta={cliente_id:clienteId,tipo_pago:'CONTADO',metodo_pago:'TRANSFERENCIA',referencia_pago:'TEST-REF',idempotency_key:ventaKey,productos:[{producto_id:productoId,cantidad:2,precio_unitario:47}]};
